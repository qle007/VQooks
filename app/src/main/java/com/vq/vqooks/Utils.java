...
public final class Utils {
     ...
     */
    private static ArrayList<Recipes> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            ArrayList<Recipes> returnRecipes = new ArrayList<>();
            // looping to retrieve all the recipes
            for (int counter = 0; counter < array.length(); counter++) {
                // Extract out the first recipe
                JSONObject object = array.getJSONObject(counter);

                // Extract out the name, ingredients, intruction
